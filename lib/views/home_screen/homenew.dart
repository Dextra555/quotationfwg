      ...
      bottomNavigationBar: AppBottomBar(
        ...
        onTap: (index) {
          ...
          if (index == 0) {
            ...
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const LeadsPage()));
          } else if (index == 2) {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const SecurityInvoicePage()));
          } else if (index == 3) {
