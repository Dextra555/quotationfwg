...
class _SecurityInvoicePageState extends State<SecurityInvoicePage> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text("Save Client", style: GoogleFonts.poppins(color: Colors.white)),
              ),
            )
          ],
        ),
  ...
  Widget _tile(String t, String v) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(t, style: GoogleFonts.poppins(fontSize: 12, color: textGrey)),
          const SizedBox(height: 4),
      ...
      Row(
        ...
        children: [
          ...
          Row(children: [
            ...
            Text(val.toString(), style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
